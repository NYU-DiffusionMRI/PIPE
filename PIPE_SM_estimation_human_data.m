...
t=toc; fprintf('================== Done with computing voxel-wise alpha in %f seconds\n',t)

Cond_alpha = PIPE.vectorize(Cond_alpha,mask);
gamma_hat = PIPE.vectorize(gamma_hat,mask);


IMGUI(Cond_alpha,[0 10]), set(gcf, 'Position', [83.5714 29.7333 168.2857 40.3333])
